...
const zhTraditionalTranslations = {
  ...
  channelRecommendationSubmitted: "頻道推薦已成功提交",
  errorSubmittingChannelRecommendation:
    "提交頻道推薦時發生錯誤",
  errorFetchingChannelRecommendations:
    "獲取頻道推薦時發生錯誤",
  noRecommendedChannelsYet: "尚未推薦任何頻道",
  submitted: "提交日期",
  approved: "已批准",
  pending: "待審核",
  rejected: "已拒絕",
...
const jaTranslations = {
  ...
  comingSoon: "近日公開",
  temporarilyUnavailable: "暫時無法使用",
  paymentSuccessfulDescription: "ご購入ありがとうございます。会員資格がアップグレードされました。",
  ...
  reportError: "エラーを報告",
  reportVideoError: "動画エラーを報告",
  errorType: "エラータイプ",
  errorDescription: "エラーの説明",
  transcriptError: "字幕エラー",
  timingError: "タイミングエラー",
  missingContent: "コンテンツが不足",
  errorTypeOther: "その他",
  pleaseSelectErrorType: "エラータイプを選択してください",
  pleaseEnterErrorDescription: "エラーの説明を入力してください",
  describeErrorInDetail: "エラーを詳しく説明してください",
  submitReport: "報告を送信",
  errorReportSubmitted: "エラー報告が正常に送信されました",
  errorSubmittingReport: "報告の送信中にエラーが発生しました",
  reportVideo: "動画",
  channelName: "チャンネル",
  shortcutKeysHelp: "下のボタンをクリックしてから、任意のキーを押してショートカットを設定してください",
  pressAnyKeyToSet: "任意のキーを押してショートカットを設定：",
  repeatCurrentSentence: "現在の文を繰り返す",
  playPreviousSentence: "前の文を再生",
  playNextSentence: "次の文を再生",
  pressKey: "キーを押してください...",
  tip: "ヒント",
  shortcutKeysTip: "これらのショートカットは動画プレイヤーがアクティブな時に機能します。単一キーまたは組み合わせキーをお使いください。組み合わせキーはサポートされていません。",
};
...
const koTranslations = {
  ...
  paymentSuccessfulDescription: "구매해 주셔서 감사합니다. 회원 자격이 업그레이드되었습니다.",
  ...
  reportError: "오류 신고",
  reportVideoError: "비디오 오류 신고",
  errorType: "오류 유형",
  errorDescription: "오류 설명",
  transcriptError: "자막 오류",
  timingError: "타이밍 오류",
  missingContent: "콘텐츠 누락",
  errorTypeOther: "기타",
  pleaseSelectErrorType: "오류 유형을 선택하세요",
  pleaseEnterErrorDescription: "오류 설명을 입력하세요",
  describeErrorInDetail: "오류를 자세히 설명해 주세요",
  submitReport: "신고 제출",
  errorReportSubmitted: "오류 신고가 성공적으로 제출되었습니다",
  errorSubmittingReport: "신고 제출 중 오류가 발생했습니다",
  reportVideo: "비디오",
  channelName: "채널 이름",
};
