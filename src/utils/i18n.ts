...
const zhTranslations = {
  ...
  channelRecommendation: "频道推荐",

  // Channel recommendation translations
  recommendYoutubeChannel: "推荐YouTube频道",
  yourRecommendedChannels: "您推荐的频道",
  helpUsGrowByRecommending:
    "通过推荐您喜欢的语言学习YouTube频道来帮助我们成长。",
  enterYoutubeChannelLink: "输入YouTube频道链接",
  pleaseEnterYoutubeChannelLink: "请输入YouTube频道链接",
  pleaseEnterValidYoutubeUrl: "请输入有效的YouTube链接",
  enterChannelName: "输入频道名称",
  pleaseEnterChannelName: "请输入频道名称",
  channelRecommendationSubmitted: "频道推荐提交成功",
  errorSubmittingChannelRecommendation: "提交频道推荐时出错",
  errorFetchingChannelRecommendations: "获取频道推荐时出错",
  noRecommendedChannelsYet: "您还没有推荐任何频道",
  submitted: "提交时间",
  approved: "已批准",
  pending: "审核中",
  rejected: "已拒绝",
...
const zhTraditionalTranslations = {
  ...
  channelRecommendationSubmitted: "頻道推薦提交成功",
  errorSubmittingChannelRecommendation: "提交頻道推薦時出錯",
  errorFetchingChannelRecommendations: "獲取頻道推薦時出錯",
...
const jaTranslations = {
  ...
  // Channel recommendation translations
  recommendYoutubeChannel: "YouTubeチャンネルを推薦",
  yourRecommendedChannels: "あなたの推薦チャンネル",
  helpUsGrowByRecommending:
    "あなたのお気に入りの言語学習YouTubeチャンネルを推薦して、私たちの成長にご協力ください。",
  ...
  channelRecommendationSubmitted: "チャンネル推薦が正常に送信されました",
  errorSubmittingChannelRecommendation:
    "チャンネル推薦の送信中にエラーが発生しました",
  errorFetchingChannelRecommendations:
    "チャンネル推薦の取得中にエラーが発生しました",
